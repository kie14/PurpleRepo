//Shellcode execution via WinAPI CreateRemoteThread Process Injection
using System;
...
namespace EX_2
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Please give either one argument for a process to inject, e.g. \".\\EX-2.exe explorer\", or leave empty for auto-injection.");
                return;
            }
